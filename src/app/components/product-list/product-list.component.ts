...
export class ProductListComponent implements OnInit {
  ...
  public handleListProducts(){
     ...
     //check id "id" parameter is availabel
     const hasCategoryId: boolean = this.route.snapshot.paramMap.has('id');

     if(hasCategoryId){
       //get the "id" param string and convert string to number using "+"
       this.currentCategoryId = Number(this.route.snapshot.paramMap.get('id'));
       
     }
     else{
       //not category id available...default to catgory id 1
  ...
  public addToCart(theProduct: Product){
